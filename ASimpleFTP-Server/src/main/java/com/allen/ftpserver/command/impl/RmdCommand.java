...
/**
 * @ClassName RmdCommand
 * @Description
 * @Author XianChuLun
 * @Date 2020/6/3
 * @Version 1.0
 */
public class RmdCommand extends AbstractCommand {

    public RmdCommand() {
        super(true, "Usage: RMD  <SP> <pathname> <CRLF>");
    }
    ...
    public void execute(String[] args, FTPConnection connection) {
        ...
        try {
            ...
            if(!file.isDirectory()){
                connection.sendReply(Reply.ACTION_NOT_TAKEN, "Not a directory, is a file");
                return;
            }
